...
Este Pan es típico de las panaderías en Venezuela y lo hemos preparado de cuatro (4) formas distintas mejorando la técnica de preparación, desde el método directo, uso de prefermentos y finalmente nuestra masa madre la Talvina.
...
- 12 Panes de 50 gramos de masa cada uno. Masa total de 600 gramos
...
- Forma una bola y deja reposar tapada con un envase durante treinta (30) minutos. 
...
- Voltea la bola (el lado liso por arriba), bolea un poco sin generar mucha tensión y cubrirlas con una bolsa plástica.
...
- Media hora antes de finalizar la segunda fermentación (maduración), enciende el horno a una temperatura de 180ºC - 355ºF. 
...
- En el centro superior de cada pastón, realiza una cruz, haciendo tres cortes, uno primero y luego de bada lado para hacer la forma de la piñita.
...
Para la concepción de este pan, hemos utilizado como fuente de inspiración, las fórmulas del [Chef Laszlo Gyomrey], [Instituto Europeo del PAN], el [Grupo Academico Panadero y Pastelero de Venezuela] y el libro "Panes Venezolanos" de Juan Carlos Bruzual.
