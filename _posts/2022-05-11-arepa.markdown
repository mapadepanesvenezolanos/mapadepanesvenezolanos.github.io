...
- Divide la masa en seis (6) porciones iguales de ciento setenta (160) gramos cada una.
...
- Coloca tus primeros tres (3) discos de masa/arepas en la plancha, distribuidos de tal forma que estén separados al menos un centímetro en la plancha.
- Asa tus arepas durante cinco (5) minutos por cada lado.

### Prueba de cocción

- Con la ayuda de un guante de cocina, retira la arepa que deseas probar y percute uno de sus lados con tu dedo índice. Si el sonido es hueco, entonces tu arepa está lista. 
- En caso contrario, ponla de nuevo en la plancha de cocina y verifica la cocción en dos (2) minutos. 
- Repite el paso anterior con cada una de las arepas dispuestas en la plancha. 
- Retira cada arepa de la plancha de cocina, y colócalas en un recipiente seco cubiertas con un paño de tela para que mantengan el calor.

Procede a cocinar el siguiente lote de arepas, siguiendo los pasos que se indican en la etapa [Asado por lotes](#asadoporlotes)
