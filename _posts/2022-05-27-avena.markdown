---
title:  "Pan de Avena/Muesli"
subtitle: "Un pan de tradición andina pero de origen europeo."
description: "Con el Pan de Avena queremos que puedas crear un pan de molde, de miga cerrada y esponjosa, debido a la combinación de huevo, leche y mantequilla. La intención es obtener una pieza de pan con aroma y sabor pronunciado a avena. La combinación de ingredientes, ha sido pensada con la intención de recordar un poquito el sabor de los panes que hemos ubicado en la región andina del mapa de panes venezolanos, con el toque maravilloso y único que le da la avena tanto en la miga como en la costra."
date:   2022-05-25 20:54:39 -0400
permalink: /panes-venezolanos/pan-de-avena/
categories: pan enriquecido andes
keywords: pan de avena, pan de avena en horno, pan de afrecho y avena, historia del pan de avena, pan de avena y leche, pan de avena con levadura seca, como hacer pan de avena
featured_image: '/images/panes/avena/avena_01.jpeg'
formula_name: "avena"
---

#### RECETA, FÓRMULA y TÉCNICAS del Pan de Avena
...
## Tips para preparar el Pan de Avena
...
- La consistencia de la mezcla que obtendrás al finalizar el paso número 2 (ver foto número 2) es pastosa, con la que difícilmente podrás hacer la prueba de la malla de gluten. No te preocupes por este detalle, porque diseñamos la fórmula con esa intención. Si deseas obtener una mezcla de masa más consistente, agrega a la mezcla entre diez (10) y veinte (20) gramos de hojuelas de avena y amasa de nuevo hasta alcanzar mayor consistencia en la masa.
...
* Una (1) barra de pan de 885g 
* Temperatura ambiente 22ºC - 27ºC
* 65% de hidratación (media hidratación)

## Masa leudada con levadura instantánea

### Ingredientes para preparar el Pan de Avena

| Ingrediente                                                  |    Fórmula    |      Peso |
|:-------------------------------------------------------------|:-------------:|----------:|
| Harina de trigo (todo uso)                                   |       80%     |      375g |
| Afrecho                                                      |        5%     |       23g |
| Avena en polvo/Muesli                                        |       15%     |       70g |
| Agua/Leche líquida                                           |       48%     |      225g |
| Levadura instantánea                                         |        1%     |        5g |
| Sal                                                          |        1%     |        5g |
| Huevos ligeramente batidos                                   |       20%     |       94g |
| Mantequilla sin sal                                          |        8%     |       38g |
| Azúcar                                                       |        5%     |       23g |
| Extracto de malta                                            |        2%     |        9g |
| Leche en polvo                                               |        2%     |        9g |
| Avena en hojuelas/Muesli (decorado)                          |        2%     |        9g |
| -------------------------------------------------------------|---------------|-----------|
| **Total**                                                    |    **192%**   |  **885g** |

### Calculadora para preparar el Pan de Avena

{% include formulas.html %}
{% include calculadora-de-panes.html %}

## Paso a paso para preparar el Pan de Avena
...
- Reserva la sal y la mantequilla sin sal aparte. Para decorar el pastón, reserva las hojuelas de avena.
...
- Cubre la masa con una bolsa plástica y deje reposar por una (1) hora en un lugar fresco a una temperatura entre 24ºC/75ºF y 27ºC/80ºF.
...
- Deje reposar el pastón tapado aproximadamente por una hora (1h) en un lugar fresco, sin corrientes de aire, a una temperatura entre 24ºC/75ºF y 27ºC/80ºF o hasta que ** supere la prueba de maduración con el dedo.**
