...
featured_image: /images/panes/canilla/canilla_02.jpg
...
{% assign curso_canillas = site.cursos | where: "permalink", "/cursos/pan-canilla/" | first %}

{% if curso_canillas %}

## Si este paso a paso te dejó con ganas de más, el curso es el siguiente paso.

Profundiza la preparación del Pan Canilla, entiende cada etapa y trabaja la masa con mayor criterio adquiriendo nuestro **[Taller de Pan Canilla ]({{ curso_canillas.url | relative_url }})**
{% endif %}

---

### Referencias y enlaces del Pan Canilla
