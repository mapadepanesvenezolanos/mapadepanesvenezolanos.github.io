...
description: "Receta del Pan Canilla Venezolano. El pan canilla es el pan más popular en Venezuela. Diseñado para acompañar y rellenarlo con lo que te provoque. También se conoce como: pan canilla venezolano, pan canilla o simplemente canillas."
...
Realmente la Canilla es una barra sobada de baja hidratación, es más parecido a un Pan Candeal que a una Baguette, solamente comparten la forma.

<img class="post_image post_image_right" src="{{page.featured_image}}" alt="{{page.title}}">

## Tips para preparar Pan Canilla
