...
featured_image: '/images/panes/perro/perro-caliente_02.jpg'
formula_name: "perros"
---
...
{% assign curso_perros = site.cursos | where: "permalink", "/cursos/perros-hamburguesas/" | first %}

{% if curso_perros %}

## Si este paso a paso te dejó con ganas de más, el curso es el siguiente paso.

Profundiza la preparación de los Panes de empaque, especialmente el de perros calientes, entiende cada etapa y trabaja la masa con mayor criterio adquiriendo nuestro **[Taller de Panes de empaque ]({{ curso_perros.url | relative_url }})**
{% endif %}
